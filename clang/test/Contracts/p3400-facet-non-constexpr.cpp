...
// the result is evaluated during translation.  Attempting that evaluation
// with diagnostics discarded makes the facet quietly do nothing -- the label
// looks applied, and the comment or semantic is simply unchanged.  That is
// the quietest way to get a label wrong: no diagnostic, no effect.
//
