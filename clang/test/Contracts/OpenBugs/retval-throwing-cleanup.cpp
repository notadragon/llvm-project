...
//
// No contracts involved; plain C++17.  It is the no-contract control for the
// contracts-side version of the same bug: if the plain-C++ case is also wrong,
// the defect is not in the contract machinery.
