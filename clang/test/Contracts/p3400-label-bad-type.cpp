...
//
// The label must be a class type with an 'assertion_control_object' member
// type.  Without that check a struct lacking the member, a struct with a
// non-type member of that name, and an integer literal are all accepted as
// labels.
