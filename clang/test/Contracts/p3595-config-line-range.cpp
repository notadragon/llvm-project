...
// P3595 x config: a comma-separated location line list mixing a single line
// and a multi-line range.  The config sets one single line and one range of
// this file to ignore, and everything else to observe.
// LINE NUMBERS ARE LOAD-BEARING -- the .json names them; do not reflow above.
