...
// not leak into an *unrelated* contract-free definition (D4299).  A contract
// attached to a prototype must be parsed and applied only to its own
// function, and must not reach ParseDeclGroup's assert(false).
