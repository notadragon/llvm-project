...
//
// This is the negative case, and it needs pinning because it is silent: a
// non-const allowed_semantics is ignored without a diagnostic, the near-miss
// warning deliberately not probing the data-member facets.  Its sibling for
// group_names is pinned in Runnable/p3400-facet-group-const.cpp.
//
