// P3100: misaligned access configured to "enforce": reports (sem=3) then
// terminates (Clang supports the throwing enforce directly).
...
// CHECK: VIOL kind=7 sem=3 comment=[misaligned pointer access]
