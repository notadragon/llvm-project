...
//
// The message is parsed in a constant-evaluated context and its
// .size()/.data() are extracted the way a static_assert message's are.  Two
// ways to get it wrong: crash the parser on a non-string-literal, or accept
// it and deliver the text empty.
