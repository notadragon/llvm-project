...
// odr-use, independent of its definition.  An inline virtual member that is
// only ever called polymorphically never has its definition instantiated, so
// without that its contract stays the dependent pattern copy, and the P3097
// contract wrapper ICEs trying to emit it.
