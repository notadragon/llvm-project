...
// initializer.  If the dependent placeholder survives to CodeGen it reaches
// getTypeInfoImpl and asserts with "Unknown builtin type", which is what a
// template enclosing the function exposes.
