...
//
// extractGroupNames must read group_names from the
// __combined_identification_label base subobject, including nested
// combinations; otherwise a combined label does not propagate group_names and
// the "safety" group config never applies to it.
