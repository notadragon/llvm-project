...
//
// __combined_label::handle_contract_violation must ask whether the component
// returns void BEFORE it names the result.  Writing
...
// already ill-formed, so combining any void-returning handler fails to
// compile with "variable has incomplete type 'void'".
