...
//
// This requires FindInstantiatedDecl to treat a PostconditionCaptureDecl as a
// local decl and remap it through the instantiation scope, the way it does a
// ResultNameDecl.  Without that the predicate's capture reference stays the
// dependent pattern capture and codegen hits "DeclRefExpr for Decl not
// entered in LocalDeclMap?".
