...
//
// extractGroupNames must read group_names from the owning base subobject.  A
// combined label carries it in the __combined_identification_label base, so
// looking only for a direct field finds nothing and the safety/audit groups
