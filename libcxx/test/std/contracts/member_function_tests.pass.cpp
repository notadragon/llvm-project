// ADDITIONAL_COMPILE_FLAGS: -std=c++26 -Xclang -fcontracts -fcontract-evaluation-semantic=enforce -fcontracts-group-evaluation-semantic=observe:observe,enforce:enforce -g
