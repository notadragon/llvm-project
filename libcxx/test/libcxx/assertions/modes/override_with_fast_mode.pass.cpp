...
// XFAIL: hwasan
// ADDITIONAL_COMPILE_FLAGS: -U_LIBCPP_HARDENING_MODE -D_LIBCPP_HARDENING_MODE=_LIBCPP_HARDENING_MODE_FAST -fcontracts-group-evaluation-semantic=std:enforce,std.valid_element_access:enforce,std.compatible_allocator:ignore
